...
<?php 
$answers = [
    "Apa kepanjangan dari HTML?" => "Hyper Text Markup Language",
    "Bagaimana cara mengatur latar belakang halaman menjadi warna merah dalam CSS?" => "background-color: red;",
    "Tag HTML apa yang digunakan untuk membuat baris baru?" => "br",
    "Apa fungsi utama dari PHP?" => "Memproses data di sisi server",
    "Bagaimana cara menampilkan gambar di HTML?" => "img src='gambar.jpg'"
];
